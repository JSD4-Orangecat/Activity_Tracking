...
export default function DashboardProgress() {
  ...
  return (
    <div className="progress-container">
      <h2 className="progress-text" id="progress-text-title">
        {rank.rankName}
      </h2>
      <div className="progress-content">
        <div className="progress-medal">
          <img
            ...
            id="top-medal"
            src={rank.rankImage}
            alt={`${rank.rankName} rank image`}
          />
        </div>
        <div className="progress-next">
          <p className="progress-text" id="progress-text-next">
            {rank.nextRank}
          </p>
